...
cache
  .package('pkg:npm/%40khulnasoft/dependency-submission@0.1.2')
...
manifest.addDirectDependency(
  cache.package('pkg:npm/%40khulnasoft/dependency-submission@0.1.2')
)
...
describe('Snapshot', () => {
  it('renders expected JSON', () => {
    ...
    expect(roundTripJSON(snapshot)).toEqual({
      detector: {
        name: 'test detector',
        url: 'https://github.com/khulnasoft/dependency-toolkit',
        version: '0.0.1'
      },
      version: 0,
      job: {
      ...
      manifests: {
        test: {
          resolved: {
            'pkg:npm/%40khulnasoft/dependency-submission@0.1.2': {
              package_url: 'pkg:npm/%40khulnasoft/dependency-submission@0.1.2',
              relationship: 'direct',
